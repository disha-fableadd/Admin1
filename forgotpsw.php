        ...
        <div class="authentication-inner py-6 mx-4">
          ...
          <div class="card p-7">
            ...
            <div class="card-body mt-1">
              ...
              <form id="forgotPasswordForm" method="POST" class="mb-5">
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response === "Password reset link has been sent to your email.") {
                                $("#message").html(`<div class="text-success">${response}</div>`).show();
                            } else {
                                $("#message").html(`<div class="text-danger">${response}</div>`).show();
                            }
                        },
